              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="FileUpload.jsp">File Upload</a></li>  
                          <li class="scroll-to-section"><a href="MyFiles.jsp" class="active">My Files</a> </li>        
      ...
      <div class="row">
        <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from uploads where dpid ='" + dpid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><%=rs.getString("enkey")%></td>
                                    <td><%=rs.getString("time")%></td>
                                    <td><a href="Fdownload1.jsp?fid=<%=rs.getString("id")%>&fname=<%=rs.getString("fname")%>"  class="btn btn-success" style="color: white">&nbsp;Download</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
