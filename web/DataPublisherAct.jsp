              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="DataPublisherAct.jsp" class="active">Data Publishers</a></li>  
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="header-text">
            <h2>Data Publishers Approval</h2>
    ...
    <div class="container">
       <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from datapub where ustatus ='No'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="DPActivate?uid=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;Approve</a>&nbsp;&nbsp;
                                        <a href="DPReject?uid=<%=rs.getString("id")%>"   class="btn btn-danger" style="color: white">&nbsp;Reject</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
