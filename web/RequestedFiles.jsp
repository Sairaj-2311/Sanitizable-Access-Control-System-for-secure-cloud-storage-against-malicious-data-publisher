                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a href="RequestedFiles.jsp" class="active">Requested Files</a> </li>        
                ...
                <div class="row">
                    <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from searchreq where drid ='"+drid+"'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><a href="Fdownload.jsp?fid=<%=rs.getString("fid")%>&fname=<%=rs.getString("fname")%>&rid=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;View Result</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
