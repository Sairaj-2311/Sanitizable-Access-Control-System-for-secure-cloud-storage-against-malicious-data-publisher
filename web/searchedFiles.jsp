            ...
            <div class="container">
                <div class="row">
                    <center><table id="naresh">
                            ...
                            <%
                                String kword = request.getParameter("sword");
                            ...
                            <tr>
                                ...
                                <td><a href="SearchReq?fid=<%=rs.getString("id")%>" class="btn btn-success" style="color: white">&nbsp;Request</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
