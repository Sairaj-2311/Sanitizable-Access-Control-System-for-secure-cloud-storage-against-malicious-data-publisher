          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
                          <li class="scroll-to-section"><a href="CloudHome.jsp">Home</a></li>
                          <li class="scroll-to-section"><a href="CloudFiles.jsp">Cloud Files</a> </li>
                          <li class="scroll-to-section"><a href="CloudAccessRequest.jsp">Data Request</a> </li>
