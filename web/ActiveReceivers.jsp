                  ...
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                         ...
                         <li class="scroll-to-section"><a href="ActivePublishers.jsp">Active Publishers</a> </li>
                          <li class="scroll-to-section"><a href="ActiveReceivers.jsp" class="active">Active Receivers</a> </li>
    ...
    <div class="container">
       <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from datareceiver where ustatus ='Active'");
                                        while (rs.next()) {
                                %>
                                <tr>
