      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h4>Data publisher Login</h4>
          </div>
        </div>
          <div >
           <form id="contact" action="DPLog" method="post">
            <div class="row offset-lg-3" >
               ...
               <div class="col-lg-8">
                <fieldset>
                    <input type="password" name="password" id="subject" placeholder="Password" autocomplete="on" >
                </fieldset>
              </div>
          ...
          <center>
              <br><a href="DataPublisherReg.jsp">New Data Publisher Registration</a></center>
      </div>
    </div>
  </section>
  <br><br><br>
