              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="MFTransaction.jsp" class="active">File Transactions</a></li>
                ...
                <div class="row">
                    <table id="naresh" style="margin: auto;padding: 10px;">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from downloads where dpid ='"+dpid+"'");
                                        while (rs.next()) {
                                %>
                                <tr>
