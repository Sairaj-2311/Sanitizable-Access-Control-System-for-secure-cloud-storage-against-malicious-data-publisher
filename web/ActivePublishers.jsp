              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                         ...
                         <li class="scroll-to-section"><a href="ActivePublishers.jsp" class="active">Active Publishers</a> </li>
    ...
    <div class="container">
       <center><table id="naresh">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from datapub where ustatus ='Active'");
                                        while (rs.next()) {
                                %>
                                <tr>
